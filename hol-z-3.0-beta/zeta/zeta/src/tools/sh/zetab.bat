...
set JAVA=%JAVA_HOME%\bin\java -Xms64m -Xms32m
...
%JAVA% -Dzeta.stmps2eps=et-stmps2eps.bat -Dzeta.local-dataport=true -classpath %ZETABASE%\classes -Djava.library.path=%ZETABASE%\lib -Dzeta.tmpdir="c:\temp" -Dzeta.home=%ZETABASE% -Dzeta.debug.zap.keep=yes -Dzeta.latex.path=%ZETABASE%\lib\ztoolkits zeta.tools.sh.BatchCommander ZETA
